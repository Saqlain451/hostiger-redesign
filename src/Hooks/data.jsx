...
const countUpData = [
  {
    ...
    content: <CountUp end={2500} duration={4} enableScrollSpy={true}  scrollSpyOnce={true} />,
  },
  {
    icon: <HiOutlineEmojiHappy />,
    title: "Happy Clients",
    content: <CountUp end={400} duration={4} enableScrollSpy={true}  scrollSpyOnce={true} />,
  },
  {
    icon: <BiCodeAlt />,
    title: "Line of Code",
    content: <CountUp end={9478815} duration={5} enableScrollSpy={true}  scrollSpyOnce={true} />,
  },
  {
    icon: <RiCupLine />,
    title: "Cup of Tea",
    content: <CountUp end={78815} duration={5} enableScrollSpy={true}  scrollSpyOnce={true} />,
  },
];
